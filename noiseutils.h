  ...
  namespace utils
  {
    ...
    class RendererImage
    {
      ...
      public:
        ...
        /// Returns the gradient color generated
        ///
        /// @returns The gradient color of the class
        ///
        /// The gradient color is used to color each pixel of
        /// the picture depending on its altitude in the height map
        GradientColor GetGradient () const
        {
            return m_gradient;
        }
